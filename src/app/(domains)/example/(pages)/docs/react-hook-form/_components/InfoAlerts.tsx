	...
	return (
		<>
			...
			<Alert className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950">
				<Icon name="Lightbulb" className="text-blue-600 dark:text-blue-400" />
	...
	return (
		<div className="grid gap-4 md:grid-cols-2">
			<Alert className="border-purple-200 bg-purple-50 dark:border-purple-800 dark:bg-purple-950">
				<Icon name="CheckCircle" className="text-purple-600 dark:text-purple-400" />
			...
			<Alert className="border-cyan-200 bg-cyan-50 dark:border-cyan-800 dark:bg-cyan-950">
				<Icon name="Code" className="text-cyan-600 dark:text-cyan-400" />
			...
			<Alert className="border-teal-200 bg-teal-50 dark:border-teal-800 dark:bg-teal-950">
				<Icon name="Palette" className="text-teal-600 dark:text-teal-400" />
